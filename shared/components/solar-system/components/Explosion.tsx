...
import { BufferGeometry, Float32BufferAttribute, ShaderMaterial, Color, AdditiveBlending, Vector3 } from 'three'
...
const Explosion = ({ id, position, lookAt, spread = 10, onComplete }: ExplosionProps) => {
